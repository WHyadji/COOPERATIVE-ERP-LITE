      ...
      <Card sx={{ mt: 3 }}>
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            • Saldo simpanan diperbarui secara otomatis setiap kali ada
            transaksi setoran
          </Typography>
          <Typography variant="body2" color="text.secondary" paragraph>
            • Untuk melakukan setoran, silakan hubungi pengurus koperasi atau
            datang langsung ke kantor koperasi
          </Typography>
