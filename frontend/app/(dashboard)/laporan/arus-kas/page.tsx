  ...
  useEffect(() => {
    ...
    const fetchReport = async () => {
      ...
      try {
        ...
        if (!ignore)
          setError(
            err instanceof Error ? err.message : "Gagal memuat laporan arus kas"
          );
      } finally {
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box>
            ...
            <Typography color="text.secondary">Laporan Arus Kas</Typography>
          </Box>
        </Box>
            ...
            <Grid item xs={12} md={3}>
              <Card>
                <CardContent>
                  ...
                  >
                    {formatCurrency(report.totalOperasional)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
              ...
              <Card>
                <CardContent>
                  ...
                  <Typography
                    ...
                    fontWeight={600}
                    color={
                      report.totalInvestasi >= 0 ? "success.main" : "error.main"
                    }
                  >
                    {formatCurrency(report.totalInvestasi)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
              ...
              <Card>
                <CardContent>
                  ...
                  <Typography
                    ...
                    fontWeight={600}
                    color={
                      report.totalPendanaan >= 0 ? "success.main" : "error.main"
                    }
                  >
                    {formatCurrency(report.totalPendanaan)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="h5" fontWeight={700} color="inherit">
                    {formatCurrency(report.kenaikanKasBersih)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  ...
                  {report.arusKasOperasional.map((item, i) => (
                    <TableRow key={`op-${i}`} hover>
                  ...
                  {report.arusKasInvestasi.map((item, i) => (
                  ...
                  {report.arusKasPendanaan.map((item, i) => (
                    <TableRow key={`pend-${i}`} hover>
                      <TableCell>{item.kodeAkun}</TableCell>
                      <TableCell>{item.namaAkun}</TableCell>
                      <TableCell align="right">
                        {formatCurrency(item.saldo)}
                  ...
                  <TableRow hover>
                    ...
                    <TableCell align="right">
                      {formatCurrency(report.saldoKasAwal)}
                    </TableCell>
                  </TableRow>
                  <TableRow
                    sx={{
                  ...
                  >
                    <TableCell colSpan={2} sx={{ fontWeight: 700, pl: 4 }}>
                      Saldo Kas Akhir Periode
                    </TableCell>
                    <TableCell align="right" sx={{ fontWeight: 700 }}>
                      {formatCurrency(report.saldoKasAkhir)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
